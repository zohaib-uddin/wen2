...
type PaginatedResourcesWithDefault<T> = { [K in keyof PaginatedResources<T>]: PaginatedResources<T>[K] extends boolean ? false : undefined };
/**
 * @inline
 * @standalonePage
 */
...
//#endregion
export { PagesOrInfiniteOptions, PaginatedHookConfig, PaginatedResources, PaginatedResourcesWithDefault };