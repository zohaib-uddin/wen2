const require_clerkRuntimeError = require('./clerkRuntimeError-CYZdTZ_x.js');
...
*/
const isClerkAPIError = require_clerkRuntimeError.createErrorTypeGuard(ClerkAPIError);
...
var ClerkAPIResponseError = class ClerkAPIResponseError extends require_clerkRuntimeError.ClerkError {
...
*/
const isClerkAPIResponseError = require_clerkRuntimeError.createErrorTypeGuard(ClerkAPIResponseError);
...
function isKnownError(error) {
	return isClerkAPIResponseError(error) || isMetamaskError(error) || require_clerkRuntimeError.isClerkRuntimeError(error);
}
/**
...
Object.defineProperty(exports, 'ClerkOfflineError', {
  enumerable: true,
  get: function () {
    return ClerkOfflineError;
  }
});
...
Object.defineProperty(exports, 'MissingExpiredTokenError', {
  enumerable: true,
  get: function () {
    return MissingExpiredTokenError;
  }
});
...
Object.defineProperty(exports, 'is429Error', {
  enumerable: true,
  get: function () {
    return is429Error;
  }
...
Object.defineProperty(exports, 'isClerkAPIError', {
  enumerable: true,
  get: function () {
    return isClerkAPIError;
  }
});
...
Object.defineProperty(exports, 'isUnauthenticatedError', {
  enumerable: true,
  get: function () {
...
//# sourceMappingURL=error-rHNfstgh.js.map