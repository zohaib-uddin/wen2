...
var usePathnameWithoutCatchAll_exports = {};
__export(usePathnameWithoutCatchAll_exports, {
  usePathnameWithoutCatchAll: () => usePathnameWithoutCatchAll
});
module.exports = __toCommonJS(usePathnameWithoutCatchAll_exports);
var import_react = __toESM(require("react"));
var import_usePagesRouter = require("./usePagesRouter");
const usePathnameWithoutCatchAll = () => {
  const pathRef = import_react.default.useRef();
